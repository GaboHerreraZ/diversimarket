      ...
      <div className="flex gap-2 w-full">
        <label className="grid w-full">
          <input
            disabled={created}
            type="text"
            className="bg-transparent  shadow border-[0.5px] rounded px-2 py-1 focus:border-main focus:border-[1px] text-raffle-text outline-none"
            placeholder="Cupón de descuento"
          />
        </label>
        <button
          disabled={created}
          className={clsx("button-main", {
