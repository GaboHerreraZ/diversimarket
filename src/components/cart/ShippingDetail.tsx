  ...
  return (
    <section className="w-full mt-4 px-10 ">
      <header className="flex justify-between items-center border-b-[1px] border-gray-200">
        <h1 className="font-bold text-3xl pb-5 ">Dirección de Envío</h1>
        {authId && <EditAddress />}
      </header>
      ...
      {!authId && addresses.length === 0 && (
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="mt-4">
            <Link className="button-main" href="/auth/login">
              Inicia sesión
            </Link>
          </div>
        </div>
      ...
      {authId && addresses.length === 0 && (
        <div className="flex flex-col items-center justify-center">
          ...
          <Link href="/usuario/mi-direccion/nueva" className="button-main mt-2">
            Agregar Dirección
          </Link>
        </div>
      )}
      ...
      <div className="flex justify-between mt-4 pb-10">
        <Link className="button-main" href={`/checkout`}>
          Volver
        </Link>
