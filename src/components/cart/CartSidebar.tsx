...
export const CartSidebar = () => {
  ...
  return (
    ...
    >
      <aside
        className={clsx(
          "w-[350px] border-l-[1px]  border-main fixed right-0 transition-translate duration-300 h-screen bg-white",
          {
        ...
        <div className="relative h-full ">
          ...
          <div>
            {products.length === 0 && (
              <div className="text-center mt-20">
                ...
                <button className="button-main" onClick={handleSeeProducts}>
                  Ver Productos
                </button>
              </div>
            )}
          ...
          <footer className="absolute bottom-0 py-5 w-full  shadow-2xl shadow-black">
            <div className="px-4 ">
              ...
              {products.length > 0 && (
                <button onClick={handlePayment} className="button-main w-full">
                  Finalizar Compra
                </button>
              )}
            </div>
