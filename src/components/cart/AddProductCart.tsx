...
export const AddProductCart = ({
  ...
  return (
    <div className="flex w-full mt-4 md:mt-0 md:w-24  flex-row h-10 justify-center  relative bg-transparent">
      <button
        disabled={created}
        onClick={decrement}
        className={clsx(
          "bg-white text-slate-950 flex justify-center items-center border-[1px] border-main h-full w-20  cursor-pointer outline-none",
          {
      ...
      <button
        ...
        onClick={increment}
        className={clsx(
          "bg-white text-slate-950 border-[1px] border-main  h-full w-20  cursor-pointer",
          {
            "disabled:opacity-25": created,
          }
        )}
