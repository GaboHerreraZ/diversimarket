...
export const ProductOrder = () => {
  ...
  return (
    <div className="group relative w-[220px]">
      ...
      <div className="z-50 invisible group-hover:visible  w-full opacity-0 group-hover:opacity-100 absolute group-hover:text-white  transition-all duration-500">
        <ul className="border-[1px] w-full bg-white  border-gray-200 ">
          {ORDERBY.map((item, idx) => (
            <li
              key={item.id + idx}
              className="hover:bg-slate-950 hover:text-white px-4"
            >
              <label
