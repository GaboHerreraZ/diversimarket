...
export const NavbarCategories = ({ subcategories, label, gender }: Props) => {
  return (
    <li className="relative">
      ...
      <nav className="absolute z-50 border-t-[2px] border-t-main  shadow py-2 px-4 invisible opacity-0  w-[500px] -left-52  peer-hover:visible peer-hover:opacity-100 hover:opacity-100 hover:visible  transition-all duration-500 bg-white">
