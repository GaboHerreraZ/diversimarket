...
export const ProfileSidebar = ({ email }: Props) => {
  ...
  return (
    ...
    >
      <aside
        className={clsx(
          "w-[280px] border-l-[1px]  border-main fixed right-0 transition-translate duration-300 h-screen bg-white",
          {
      ...
      >
        ...
        <ul className="mt-10 grid gap-2 ">
          <li className="hover:bg-slate-950 px-10 py-2 hover:text-white transition-all duration-300 cursor-pointer">
            <Link
          ...
          <li className="hover:bg-slate-950 px-10 py-3 hover:text-white transition-all duration-300 cursor-pointer">
