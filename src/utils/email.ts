...
export const createContactEmail = (contact: Contact) => {
  ...
  <head>
      ...
      <title>Contacto Diversi Market</title>
      <style>
          body {
  ...
  <body>
      <div class="container">
          <img class="logo-img" src="https://neemxhjfpkzimvlwwlpe.supabase.co/storage/v1/object/public/publicImage/bellarte-icono.png?t=2024-03-13T20%3A05%3A15.227Z" alt="Diversi Market" />
          <h2>¡Hola!</h2>
          ...
          <p>¡Gracias por ponerte en contacto con Diversi Market!</p>
      </div>
  </body>
  </html>
    `.trim();
